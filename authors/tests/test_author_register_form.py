...
class AuthorRegisterFormUnitTest(TestCase):
    @parameterized.expand([
        ...
        ('password2', 'Repeat yout password'),
    ])
    ...
    @parameterized.expand([
        ('username', (
            'Username must be have letters, number or one of those @.+-_. '
    ...
    def test_fields_label_is_correct(self, field, placeholder):
        form = RegisterForm()
...
class AuthorRegisterFormIntegrationTest(DjangoTestCase):
    ...
    def test_password_and_password_confirmation_are_equal(self):
        self.form_data['password'] = '@A123abc123'
        self.form_data['password2'] = 'asd!@12346'
    ...
    def test_auhtor_created_can_login(self):
        url = reverse('authors:create')
